...
public class BusReservation
{
    ...
    {    
        try
        {
            ...
            System.out.println("------------------------------------------------------------------------------------------------------------------------------------------");
            System.out.println(String.format("%-15s%-20s%-20s%-30s%-20s%-20s%-20s","QUANTITY"," NAME","AGE","PHONE NO","DESTINATION","INSURANCE","MEMBERSHIP"));
            System.out.println("------------------------------------------------------------------------------------------------------------------------------------------");
            for(int c=0;c<n;c++)
            {
                if(c==0)
            ...
            System.out.println("\nThe total customer of this bus reservation ticket is " + count + "customers.");
